...
// func TestYoureDoingGreatHoney(t *testing.T) {

// }

// func TestBasicSolo(t *testing.T) {
// 	runtime.GOMAXPROCS(4)
...
// func TestBasicInOrder(t *testing.T) {
// 	runtime.GOMAXPROCS(4)
...
// func TestBasicOutOfOrder(t *testing.T) {
// 	runtime.GOMAXPROCS(4)
...
// 	pxa[0].Start(3, 600)
// 	pxa[1].Start(2, 500)
// 	waitn(t, pxa, 4, npaxos, 700)
// 	pxa[0].Start(1, 400)
// 	pxa[1].Start(0, 300)
// 	waitn(t, pxa, 3, npaxos, 600)
// 	waitn(t, pxa, 2, npaxos, 500)
// 	waitn(t, pxa, 1, npaxos, 400)
// 	waitn(t, pxa, 0, npaxos, 300)
...
// 	for i := 0; i < npaxos; i++ {
// 		pxa[i].Start(i, "hello" + fmt.Sprint(i))
// 	}

// 	for i := 0; i < npaxos; i++ {
// 		waitn(t, pxa, 0, npaxos, "hello0")
// 	}
